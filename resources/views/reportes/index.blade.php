                                            ...
                                            <div class="notika-chat-list notika-shadow tb-res-ds-n dk-res-ds">
                                                ...
                                                <div class="card-box">
                                                    ...
                                                    {!! Form::open(['route' => 'reportes.store', 'method' => 'post', 'data-parsley-validate']) !!}
                                                        ...
                                                        <hr>
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-6">
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="actividades_realizadas_t" id="actividades_realizadas_t">
                                                                    <label id="actividades_realizadas_t">Total de actividades realizadas</label>
                                                                </div>

                                                                <div class="form-group">
                                                                    <input type="checkbox" name="actividades_no_realizadas_t" id="actividades_no_realizadas_t">
                                                                    <label id="actividades_no_realizadas_t">Total de actividades realizadas</label>
                                                                </div>

                                                                <div class="form-group">
                                                                    <input type="checkbox" name="actividades_planificadas_t" id="actividades_planificadas_t">
                                                                    <label id="actividades_planificadas_t">Total de actividades planificadas</label>
                                                                </div>
                                                            </div>

                                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-6">
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="minutos_realizados_t" id="minutos_realizados_t">
                                                                    <label id="minutos_realizados_t">Total de minutos realizados</label>
                                                                </div>

                                                                <div class="form-group">
                                                                    <input type="checkbox" name="minutos_proyectados_t" id="minutos_proyectados_t">
                                                                    <label id="minutos_proyectados_t">Total de minutos proyectados</label>
                                                                </div>
